...
terraform {
  ...
  backend "s3" {
    ...
    key            = "resources/search-persister/tfstate.tf"
    region         = "eu-central-1"
...
resource "aws_lambda_function" "lambda" {
  ...
  handler       = "com.tamer84.tango.product.searchpersister.EventHandler"
  filename      = local.code
  runtime       = "java11"
...
module "cicd" {
  ...
  codebuild_build_stage = {
    ...
    "github_repo"         = "tamer84/search-persister"
